      ...
      @if (payment(); as p) {
        <div class="tactile-card p-6">
          <div class="flex flex-wrap items-start justify-between gap-3">
            <div>
              <p class="text-xs font-bold uppercase text-slate-500 tracking-wide">Mã đơn hàng</p>
        ...
        <div class="grid lg:grid-cols-2 gap-5">
          <div class="tactile-card p-5 space-y-3">
            ...
            <div class="grid grid-cols-1 gap-3 text-sm">
              <div class="rounded-xl bg-slate-50 px-4 py-3">
                ...
                <p class="mt-1 font-bold text-slate-800">User #{{ p.paidByUserId ?? '—' }}</p>
              </div>
              <div class="rounded-xl bg-slate-50 px-4 py-3">
          ...
          <div class="tactile-card p-5 space-y-3">
            <h2 class="font-extrabold text-slate-800">Liên kết</h2>
            <div class="space-y-2 text-sm">
              <div class="rounded-xl bg-slate-50 px-4 py-3">
                <p class="text-xs font-bold uppercase text-slate-500 tracking-wide">Learning Request</p>
              ...
              <div class="rounded-xl bg-slate-50 px-4 py-3">
                <p class="text-xs font-bold uppercase text-slate-500 tracking-wide">Tutor</p>
                <p class="mt-1 font-bold text-slate-800">Tutor #{{ p.tutorId ?? '—' }}</p>
              </div>
            </div>
          </div>
        </div>
