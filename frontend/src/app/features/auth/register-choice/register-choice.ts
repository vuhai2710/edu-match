    ...
    <div class="min-h-[70vh] flex items-center justify-center py-12 px-4">
      <div class="w-full max-w-3xl space-y-8">
        <div class="text-center">
          <app-mascot type="eduLogo" [size]="88" />
          <h1 class="mt-4 font-display text-3xl sm:text-4xl font-black text-slate-900">Bạn muốn đăng ký với vai trò nào?</h1>
        ...
        <div class="grid sm:grid-cols-2 gap-4">
          <a routerLink="/auth/register/student"
            ...
            <app-mascot type="studentBackpack" [size]="120" />
            <div>
            ...
            <span class="tactile-button-green w-full py-3 rounded-2xl text-sm font-extrabold uppercase">
              Đăng ký học viên
            </span>
          </a>
          ...
          <a routerLink="/auth/register/tutor"
             class="tactile-card p-6 flex flex-col items-center text-center gap-4 hover:-translate-y-1">
            <app-mascot type="tutorWand" [size]="120" />
            <div>
            ...
            <span class="tactile-button-blue w-full py-3 rounded-2xl text-sm font-extrabold uppercase">
              Đăng ký gia sư
            </span>
          </a>
        </div>
