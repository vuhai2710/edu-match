            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  ...
                  <div class="space-y-2 min-w-0 flex-1">
                    <div class="flex flex-wrap items-center gap-2">
                      ...
                      @if (t.code) {
                        <span
                          class="bg-blue-100 text-duo-blue text-xs font-extrabold px-2.5 py-1 rounded-lg border border-blue-200 uppercase"
                        >
                          {{ t.code }}
                        </span>
                      }
                    ...
                    <div
                      class="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs sm:text-sm text-slate-600 pt-2 border-t border-slate-100 mt-2"
                    >
                      <div>
                      ...
                      @if (t.email) {
                        ...
                        <div class="min-w-0 truncate">
                          ...
                          <a
                            [href]="'mailto:' + t.email"
                            class="font-extrabold text-sky-blue hover:underline truncate"
                            [title]="t.email"
                          >
                            {{ t.email }}
                          </a>
              ...
              <div class="tactile-card p-6">
                ...
                <div class="space-y-4 text-sm">
                  ...
                  @if (t.phoneNumber) {
                    <div
                      class="flex flex-col sm:flex-row sm:items-center justify-between pb-3 border-b border-slate-100"
                    >
                      <span class="text-slate-500 font-bold">Số điện thoại liên hệ</span>
                      <span class="font-extrabold text-slate-800 mt-1 sm:mt-0">{{
                        t.phoneNumber
                      }}</span>
                    </div>
                  }
                    ...
                    <div class="flex flex-col gap-2 pb-3 border-b border-slate-100">
                      ...
                      <div class="flex flex-wrap gap-1.5">
                        @for (subject of t.subjects; track subject.subjectId) {
                          <span
                            class="bg-blue-50 text-duo-blue px-2.5 py-1 rounded-lg text-xs font-bold border border-blue-100"
                          >
                            {{ subject.subjectName }}
                          </span>
                        }
                    ...
                    <div class="flex items-center justify-between pt-1">
                      <div>
                        ...
                        <span class="text-xs text-slate-400 font-semibold block mt-0.5"
                          >Tài liệu minh chứng năng lực giảng dạy</span
                        >
                      </div>
                      <a
                        [href]="t.cvUrl"
