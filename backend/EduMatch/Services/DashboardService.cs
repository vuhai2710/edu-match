...
namespace EduMatch.Services
{
  public class DashboardService : IDashboardService
  {
    ...
    public async Task<ApiResponse<TutorDashboardDto>> GetTutorDashboardAsync(long tutorProfileId)
    {
      return await ServiceResponse.ExecuteAsync(async () =>
      {
    ...
    public async Task<ApiResponse<StudentDashboardDto>> GetStudentDashboardAsync(long studentUserId)
    {
      return await ServiceResponse.ExecuteAsync(async () =>
      {
        ...
        return ApiResponse<StudentDashboardDto>.SuccessResult(new StudentDashboardDto
        {
          TotalRequests = total,
          OpenRequests = open,
