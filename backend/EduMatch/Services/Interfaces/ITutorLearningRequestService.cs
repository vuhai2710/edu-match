...
namespace EduMatch.Services.Interfaces
{
  public interface ITutorLearningRequestService
  {
    ...
    Task<ApiResponse<LearningRequestDto>> AcceptAsync(long id, long tutorProfileId);
    Task<ApiResponse<LearningRequestDto>> RejectAsync(long id, long tutorProfileId);
  }
}
